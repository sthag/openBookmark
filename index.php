...
<!-- Wrapper starts here. -->
<div id="root" style="min-width: <?php echo 230 + $settings['column_width_folder']; ?>px;">
	<!-- google search box -->
	...
	<div id="menu">
		...
		<ul class="nav" id="mnu_bookmarks">
			...
			<?php } ?>
		  <li><a class="menuLink" href="javascript:bookmarknew('<?php echo $folderid; ?>')">Create New</a></li>
		  <li><a class="menuLink" href="javascript:bookmarkedit(checkselected())">Edit</a></li>
		  <li><a class="menuLink" href="javascript:bookmarkmove(checkselected())">Move</a></li>
		  <li><a class="menuLink" href="javascript:bookmarkdelete(checkselected())">Delete</a></li>
		  <li><a class="menuLink" href="./shared.php">Show Shared</a></li>
		</ul>
		</div>
		...
		<ul class="nav" id="mnu_folders">
			<li><a class="menuLink" href="javascript:foldernew('<?php echo $folderid; ?>')">Create New</a></li>
			<li><a class="menuLink" href="javascript:folderedit('<?php echo $folderid; ?>')">Edit</a></li>
			<li><a class="menuLink" href="javascript:foldermove('<?php echo $folderid; ?>')">Move</a></li>
			<li><a class="menuLink" href="javascript:folderdelete('<?php echo $folderid; ?>')">Delete</a></li>
			<li><a class="menuLink" href="./index.php?expand=&amp;folderid=0">Collapse All</a></li>
		</ul>
		</div>
		
		<div class="navblock">
		<h2 class="nav mnu" target="mnu_tools">Tools</h2>
		<ul class="nav lastItem" id="mnu_tools">
			<?php if (admin_only ()) { ?>
			<li><a class="menuLink" href="./admin.php">Admin</a></li>
			<?php } ?>
			<li><a class="menuLink" href="./settings.php">Settings</a></li>
			<li><a class="menuLink" href="./import.php">Import</a></li>
			<li><a class="menuLink" href="./export.php">Export</a></li>
			<li><a class="menuLink" href="./index.php?search=[dupe_check_bookmarks]">Find Duplicates</a></li>
			<li><a class="menuLink" href="./sidebar.php">Sidebar</a></li>
			<li><a class="menuLink" href="./index.php?logout=1">Logout</a></li>
		</ul>
		</div>
	<!-- Menu ends here. -->
	</div>
	...
	<div id="folders" class="folders mnu <?php echo (is_mobile_browser() ? "mobile" : ""); ?>" style="width: <?php echo ($column_width_folder == 0) ? "auto" : $column_width_folder; ?>; height: <?php echo ($table_height == 0) ? "auto" : (($table_height == 1) ? "100%" : $table_height); ?>;">
	...
	<div class="bookmarks" style="height: <?php echo ($table_height == 0) ? "auto" : (($table_height == 1) ? "100%" : $table_height); ?>;">
